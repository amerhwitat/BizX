...
class SessionChannels {
  ...
  void addChat(ChatMessage message) { if (chatEnabled) chat.add(message); }
  void setChannel(SessionChannel channel, bool enabled) { if (channel == SessionChannel.chat) chatEnabled = enabled; if (channel == SessionChannel.voice) voiceEnabled = enabled; }
}
