...
class SessionPlayer {
  SessionPlayer({required this.id, required this.name, this.priority = 0, this.presence = PlayerPresence.queued, this.joinedAt = 0});
  final String id;
  final String name;
  int priority;
...
class GameSession {
  ...
  final String gameId;
  final int seats;
  final int disconnectGraceSeconds;
  final List<SessionPlayer> players = [];
  final Queue<SessionPlayer> queue = Queue<SessionPlayer>();
