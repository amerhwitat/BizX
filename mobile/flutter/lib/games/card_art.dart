...
class CardArt {
  ...
  static Widget card({required String rank, required String suit, double width = 62}) {
    final path = svgPath(rank: rank, suit: suit);
    return SizedBox(
      width: width,
  ...
  static Widget _fallback(String rank, String suit) => Container(
        ...
        child: Text('$rank${_symbol(suit)}',
          style: TextStyle(color: (suit == 'hearts' || suit == 'diamonds') ? Colors.red : Colors.black,
