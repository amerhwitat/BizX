...
class PlayerProgress { final String name, gameId, status; final int level; final int score; const PlayerProgress({this.name='Player',this.gameId='default',this.status='new',this.level=0,this.score=0}); }
