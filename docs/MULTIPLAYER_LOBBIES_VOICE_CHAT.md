...
## Scope
This architecture applies to every BizX network-enabled game: card games and future multiplayer titles use one lobby/session contract rather than bespoke matchmaking logic.
