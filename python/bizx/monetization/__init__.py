...
class MonetizationEngine:
    ...
    def purchase(self, product_id, provider="store"):
        ...
        return {"ok":True,"product_id":product_id,"provider":provider,"amount":product["price"],"status":"verification-required","payment_methods":{"ethereum":{"asset":"ETH","recipient":PAYMENT_ROUTING["primaryEthAddress"]},"paypal":{"account":PAYMENT_ROUTING["primaryPayPalAccount"]}},"default_payment_method":PAYMENT_ROUTING["defaultMethod"],"fallback_payment_method":PAYMENT_ROUTING["fallbackMethod"],"requires_explicit_user_selection":PAYMENT_ROUTING["routingRequiresExplicitUserSelection"]}
