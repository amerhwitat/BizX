...
CAT={'schema':'bizx.network.api.v1','implementation':'python','endpoints':['GET /api/v1','GET /api/v1/health','GET /api/v1/config','POST /api/v1/classify','POST /api/v1/authorize','POST /api/v1/tcp-check','GET /api/v1/interfaces']}
def classify(x):
...
class H(http.server.BaseHTTPRequestHandler):
 ...
 def do_POST(self):
  ...
  if self.path=='/api/v1/classify':
   ...
   except ValueError:return self.out({'error':'invalid_ip'},400)
